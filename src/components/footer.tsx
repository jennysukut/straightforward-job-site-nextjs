      ...
      <div className="FooterButtonContainer flex flex-row flex-wrap gap-4">
        <Link href={"/in-progress"}>
          <SiteButton
            ...
            isSelected={clickedButton === "contact"}
          >
            contact
          </SiteButton>
        </Link>
        ...
        <Link href={"/in-progress"}>
          <SiteButton
            ...
            colorScheme="d4"
            aria="our makers"
            onClick={() => setClickedButton("makers")}
            isSelected={clickedButton === "makers"}
          >
            our makers
          </SiteButton>
        </Link>
        ...
        <Link href={"/in-progress"}>
          <SiteButton
            ...
            colorScheme="f3"
            aria="our supporters"
            onClick={() => setClickedButton("supporters")}
        ...
        <Link href={"/in-progress"}>
          <SiteButton
            ...
            colorScheme="e6"
            aria="about"
            onClick={() => setClickedButton("about")}
        ...
        <Link href={"/job-board"}>
          <SiteButton
            ...
            colorScheme="c4"
            aria="Job Board"
            onClick={() => setClickedButton("job board")}
            isSelected={clickedButton === "job board"}
          >
            job board
          </SiteButton>
        </Link>
