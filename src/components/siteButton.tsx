...
const SiteButton: React.FC<ButtonProps> = ({
  ...
  return (
    <div className="ButtonContainer relative">
      ...
      <div
        className={`ButtonShadow absolute -right-1.5 top-1.5 rounded-full text-transparent ${variant === "hollow" ? "border-[3px] border-jade" : ""} ${buttonSize} ${buttonColors[colorScheme].color2} ${addClasses}`}
      >
        {children}
      </div>
    </div>
